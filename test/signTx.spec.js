...
const TestRelayer = require('./TestRelayer');
...
describe('burner-core', () => {
  ...
  it('Should sign a send tx', (done) => {
    ...
    testRelayer.addResponder('eth_sendRawTransaction', ([signedTx]) => {
